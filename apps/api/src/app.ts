...
import { questionSessionsRouter } from "./routes/question-sessions";
import { questionRatingsRouter } from "./routes/question-ratings";
...
export function createApp() {
  ...
  app.use("/api/question-ratings", questionRatingsRouter);
