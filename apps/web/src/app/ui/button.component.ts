...
/**
 * Attribute-selector component: attaches to a real <button>, so it keeps
 * native form/click/focus/disabled behavior instead of wrapping it in a
 * custom element. Usage: <button appButton variant="outline">Save</button>.
 */
@Component({
